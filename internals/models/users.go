...
var (
	userAllColumns            = []string{"id", "first_name", "last_name", "email", "password", "created_at", "updated_at"}
	userColumnsWithoutDefault = []string{}
	userColumnsWithDefault    = []string{"id", "first_name", "last_name", "email", "password", "created_at", "updated_at"}
